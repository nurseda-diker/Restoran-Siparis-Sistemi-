...
if($_GET["action"]=="delete"){
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container">   
                <?php  
                $query = "SELECT * FROM maindishes ORDER BY id ASC";  
                ...
                ?>  
                <div class="col">  
                     <form method="post" action="maindishdb.php?action=add&id=<?php echo $row['id']; ?>">  
			...
			<br />
                     ...
                     <table>  
                          ...
                          <tr>  
                               ...
                               <td><a href="maindishdb.php?action=delete&id= <?php echo $values['id']; ?>">Remove</a></td> 
                          </tr>  
                          <?php  
